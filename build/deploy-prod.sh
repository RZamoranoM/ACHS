...
sfdx config:set defaultusername=consultor_force@nectia.com.qa 
sfdx force:mdapi:deploy -c -d pruebaPackage -u my-hub-orgQA -w 10 #-l RunLocalTests -w 33 --verbose --loglevel fatal
